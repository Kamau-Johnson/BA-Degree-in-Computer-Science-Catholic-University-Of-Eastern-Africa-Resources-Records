...
describe category;
insert into category(catname,descr)
values ('Electronics','Electronics'),('Appliances','Appliances'),
('Detergents','Detergents'),('Vegetables','Vegetables'),('Wheat','Wheat');
select * from category;

insert into products(prodcode,prodname,price,catname)
values(1,'Smart TV',120000,'Electronics'),
(2,'Sunlight',299,'Detergents'),
(3,'Microwave',2500,'Appliances');

select * from products;

describe products;

insert into orders(ordeordersrdate,quantity,custno,prodcode)
values('2020-05-01',1,1,3),
('2020-03-25',4,1,3),
('2020-07-21',3,2,1),
('2022-02-25',2,3,1),
('2024-02-14',2,2,2);
